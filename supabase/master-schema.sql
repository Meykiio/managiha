-- ============================================================
-- MANAGIHA — Master Schema
-- Single idempotent migration for a fresh Supabase project.
-- Consolidates migrations 00000–00011.
-- ============================================================
...
-- ── RPC: handle_new_user (signup trigger) ───────────────────
...
-- ── RPC: adjust_stock (final: count_adjustment semantics) ───
...
-- ── RPC: get_dashboard_stats (final: with product_count) ────
...
-- ── Guard triggers (RPC-only columns) ───────────────────────
...
-- ── View: products_overview (security_invoker) ──────────────
